...
public class AdminProfileEditRiderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_edit_rider);
        ...
        checkVerified = findViewById(R.id.isVerified);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                inputData();
                startActivity(new Intent(AdminProfileEditRiderActivity.this, AdminUsersMainActivity.class));
            }
    ...
    private void inputData() {
        ...
        isVerified = checkVerified.isChecked();
    ...
    private void updateProfile() {
        ...
        if (image_uri ==null){
            ...
            hashMap.put("riderAccepted",""+isVerified);
            ...
            ref.child(uid).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(AdminProfileEditRiderActivity.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            // Failed Show error message
                            Toast.makeText(AdminProfileEditRiderActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds: snapshot.getChildren()){
                            ...
                            String isVerified = ""+ds.child("isVerified").getValue();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        //cancelled
                        Toast.makeText(AdminProfileEditRiderActivity.this, "Cancelled...", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        image_uri = getImageUri(AdminProfileEditRiderActivity.this ,bitmap);
