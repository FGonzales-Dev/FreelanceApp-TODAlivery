...
public class ProfileEditUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                inputData();
                startActivity(new Intent(ProfileEditUserActivity.this, UserProfileActivity.class));
            }
            ...
            ref.child(firebaseAuth.getUid()).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(ProfileEditUserActivity.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                        }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        image_uri = getImageUri(ProfileEditUserActivity.this ,bitmap);
