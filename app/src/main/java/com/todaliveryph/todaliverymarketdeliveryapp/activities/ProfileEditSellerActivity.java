...
public class ProfileEditSellerActivity extends AppCompatActivity {
    ...
    private EditText nameET, phoneET, feeET, addressET, shopnameET;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                inputData();
                startActivity(new Intent(ProfileEditSellerActivity.this, SellerProfileActivity.class));
            }
        });
    ...
    private String name, shopName, phone, deliveryFee, address;
            ...
            ref.child(firebaseAuth.getUid()).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(ProfileEditSellerActivity.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                        }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        image_uri = getImageUri(ProfileEditSellerActivity.this ,bitmap);
