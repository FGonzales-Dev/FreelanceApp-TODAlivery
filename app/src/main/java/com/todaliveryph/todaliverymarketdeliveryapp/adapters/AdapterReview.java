        ...
        ref.child(uid)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        try{
                            Picasso.get().load(profileImage).placeholder(R.drawable.review_icon_person).into(holder.profileIv);
                        }catch (Exception e){
                          holder.profileIv.setImageResource(R.drawable.review_icon_person);
                        }
